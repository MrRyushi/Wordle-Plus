		...
		<div className=''>
			...
			<div className='space-y-4'>
				...
				<div className='flex gap-3 justify-center items-center poppins'>
					...
					<button className='border rounded-2xl px-3 py-2 hover:bg-slate-200 text-lg w-1/3' onClick={() => navigate('/register')}>Register</button>
					<button className='border rounded-2xl px-3 py-2 bg-slate-950 hover:bg-slate-900 text-slate-50 text-lg w-1/3' onClick={() => navigate('/login')}>Log in</button>
				</div>
			</div>
		</div>
    </div>
